...
public class BarcodeCreator {
	...
	public static int createBarcode(Content pConent) throws Exception {

		int nMaxHeight = 0;
		int nMaxWidth = 0;

		Vector<String> pTokens = pConent.Parts;
		String strHash = pConent.Hash;

		for (int i = 0; i < pTokens.size(); i++) {

			String strValue = pTokens.get(i);

			String strPrefix = (i + 1) + "/" + pTokens.size() + "/T/" + strHash + "|";
			...
			jBufferedImage = new BufferedImage(jImage.getWidth(null) * 2, jImage.getHeight(null) * 2,
